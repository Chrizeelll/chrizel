                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="../../images/AdminLTELogo.png" alt="user image">
                        <span class="username">
                    ...
                    <div class="post">
                      ...
                      <div class="row mb-3">
                        <div class="col-sm-6">
                          <img class="img-fluid" src="../../images/AdminLTELogo.png" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                          <div class="row">
                            <div class="col-sm-6">
                              <img class="img-fluid mb-3" src="../../images/AdminLTELogo.png" alt="Photo">
                              <img class="img-fluid" src="../../images/AdminLTELogo.png" alt="Photo">
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                      ...
                      <td>
                          <ul class="list-inline">
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="../../images/AdminLTELogo.png">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="../../images/AdminLTELogo.png">
                              </li>
